...
- on n'a pas de page de connexion pour l'admin ?
- j'avais un doute sur la ligne "Technologies : raw HTML/CSS/JS" dans les notes
  - ne vous laissez pas inflencer, en particulier si le client ne s'y connait pas trop.
- du NoSql , si il n'y pas d'utilisateur?
...
- quelle architecture de solution ? plutôt SSR ou plutôt API / SPA ? 
