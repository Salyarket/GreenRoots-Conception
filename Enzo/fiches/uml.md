...
## 5. Diagramme d'états (ou états-transitions)
...
- **À quoi ça sert** : Montrer comment les composants sont déployés sur des machines physiques ou virtuelles.
- **Exemple** : Afficher où sont installés les serveurs web, bases de données, etc.
