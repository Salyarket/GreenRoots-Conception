...
- Etant donné le sujet porté, une attention toute particulière devra être donnée à l’éco-conception.
- Inspiration graphique possible en se basant sur des sites comme [Reforest’Action](https://www.reforestaction.com/), [all4trees](https://all4trees.org/soutenir/planter-des-arbres/), [ArborDay](https://www.arborday.org/), [OneTreePlanted](https://onetreeplanted.org/), etc.
