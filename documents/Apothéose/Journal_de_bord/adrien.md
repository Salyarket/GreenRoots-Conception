# Journal de bord - Projet GreenRoots - Adrien 
...
>⚠️ ⚠️ ⚠️ **A récupérer :** lors du dévellopement en récupérant le dossier Images : ⚠️ ⚠️ ⚠️
> - Récupération de quelques éléments graphiques sur des banques d'images (icons8 & Freepix) 

<br>

> 🎯 **Prochaines étapes :** Il serait interessant de faire également : 
...
### Toute l'équipe 
> ✅ **Check et validation :** en équipe du travaille de Tarig et Oumaïma : 
> - 📂 [Des User Stories](user-stories.md)
> - 📂 [Recueil de données](merise/recueil-données.md)
> - 📂 UML 
>     - [cas d'utilisation](uml/[cas_d'utilisation]/dcu-global.puml) 
>     - Diagramme de séquence => [Validation du panier](uml/[sequence]/validation-panier.puml)
