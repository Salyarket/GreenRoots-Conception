...
| `email`     | VARCHAR(255)                                     | ✅     | ✅       | -         | -             | "[alice@mail.com](mailto:alice@mail.com)" | Adresse email de l’utilisateur                  |
...
| `unit_price` | DECIMAL(10,2) | ❌     | ✅       | -           | 0.0        | 15.50             | Prix unitaire au moment de la commande |
