...
| Date     | Tâches prévues                  | Tâches réalisées (faites)      | Remarques / Suivi           |
| -------- | ------------------------------- | ------------------------------ | --------------------------- |
| 10/09/25 | Faire le MCD                    | Fini le MCD                    | À valider avec l’équipe     |
| 10/09/25 | Implémenter API produits (CRUD) | Routes POST et GET terminées   | PATCH et DELETE pour demain |
...
- Point à 10H30 avec Guillaume et Virginie pour faire un tour de la conception réalisée jusqu'à présent
- Continuité de mise en forme des wireframes : 
>- Ajout de commentaires sur les éléménts
- Création du logo Green Roots
